...
const LandingPage = () => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-[#09090b] text-white' : 'bg-gray-50 text-gray-900'} overflow-x-hidden`}>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className={theme === 'dark' ? 'text-white' : 'text-gray-800'}>Modern Equipment</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-cyan-500" />
                  <span className={theme === 'dark' ? 'text-white' : 'text-gray-800'}>AC Facility</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-cyan-500" />
                  <span className={theme === 'dark' ? 'text-white' : 'text-gray-800'}>Personal Training</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="text-cyan-500" />
                  <span className={theme === 'dark' ? 'text-white' : 'text-gray-800'}>Diet Consultation</span>
                </div>
              </div>
            </div>
      ...
      {/* Services Section */}
      <section id="services" className={`py-24 ${theme === 'dark' ? '' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <Card key={index} className={`${theme === 'dark' ? 'bg-zinc-900/50 border-zinc-800' : 'bg-gray-50 border-gray-200 shadow-md'} hover:border-cyan-500/50 transition-all group`}>
                <CardContent className="p-6">
                  <div className={`w-14 h-14 ${theme === 'dark' ? 'bg-cyan-500/20' : 'bg-cyan-100'} rounded-xl flex items-center justify-center mb-4 group-hover:bg-cyan-500/30 transition-colors`}>
                  ...
                  <p className={theme === 'dark' ? 'text-zinc-400' : 'text-gray-600'}>{service.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
