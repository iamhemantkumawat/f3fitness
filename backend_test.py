...
class F3FitnessAPITester:
    def __init__(self, base_url="https://f3-fitness-gym.preview.emergentagent.com"):
    ...
    def test_create_member(self):
        ...
        test_member_data = {
            "name": "Test Member",
            "email": f"testmember_{datetime.now().strftime('%H%M%S')}@example.com",
            "phone_number": f"999000{datetime.now().strftime('%H%M')}",
            "password": "test123",
            "gender": "male",
...
def main():
    ...
    print(f"Backend URL: https://f3-fitness-gym.preview.emergentagent.com")
    print("="*60)
